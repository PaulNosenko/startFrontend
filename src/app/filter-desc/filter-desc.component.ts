...
@Component({
  selector: 'app-filter-desc',
  templateUrl: './filter-desc.component.html',
  styleUrls: ['./filter-desc.component.css']
})


export class FilterDescComponent implements OnInit, OnDestroy {
  page:number=0;
  count:number=9;
  pages:Array<number>;
  ...
  findAll(page:number, count:number){
    this.userService.filterPriceDesc(page, count).subscribe((responseApi:ResponseApi) => {
