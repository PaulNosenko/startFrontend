...
@Component({
  selector: 'app-filtered-asc',
  templateUrl: './filtered-asc.component.html',
  styleUrls: ['./filtered-asc.component.css']
})


export class FilteredAscComponent implements OnInit, OnDestroy {
  page:number=0;
  count:number=9;
  pages:Array<number>;
  ...
  findAll(page:number, count:number){
    this.userService.filterPriceAsc(page, count).subscribe((responseApi:ResponseApi) => {
